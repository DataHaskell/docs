...
### Trees
  ...
  - **KdTree**  [](https://github.com/binarysunrise-io/kdtree){:.github} [![Hackage](https://img.shields.io/hackage/v/KdTrees.svg)](https://hackage.haskell.org/package/KdTrees) [![KdTrees](http://stackage.org/package/KdTrees/badge/lts-11)](http://stackage.org/lts-11/package/KdTrees) [![KdTrees](http://stackage.org/package/KdTrees/badge/nightly)](http://stackage.org/nightly/package/KdTrees) : A simple library for k-d trees in Haskell. It enables searching through collections of points in O(log N) average time, using the nearestNeighbor function.
